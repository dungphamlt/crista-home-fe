...
/** Giống SocialSidebar: Facebook, Zalo, Hotline (cùng URL). */
const SOCIAL_SHARE = [
  {
    ...
    <div className="container py-8 mb-6 lg:mb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-4">
          ...
          {/* Box 3: Social share — cùng style SocialSidebar, xếp ngang */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex flex-row flex-wrap items-center gap-4">
              {SOCIAL_SHARE.map(({ href, label, image, accent }, index) => (
                <a
                  key={label}
                  href={href}
                  ...
                  className="group relative rounded-full bg-white animate-social-sidebar-in transition-transform duration-200 ease-out hover:scale-[1.12] hover:-translate-y-1 active:scale-[0.94]"
                >
                  <span
                  ...
                  />
                  <span className="relative flex h-10 w-10 items-center justify-center rounded-full transition-transform duration-300 ease-out group-hover:-translate-y-0.5 group-hover:scale-110">
                    <Image
                      src={image}
                      alt=""
                      width={40}
